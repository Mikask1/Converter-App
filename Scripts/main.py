...
class App(QDialog):
    ...
    def mergePNG_option(self):
        ...
        button_vertical.setStyleSheet(
            "background-image : url('../resources/Horizontal.png');background-color:transparent")
        ...
        button_horizontal.setStyleSheet(
            "background-image : url('../resources/Vertical.png');background-color:transparent")
